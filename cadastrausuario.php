    ...
    <body>
        ...
        <div class='titulo'>
            ...
            <div class='container-cadastro'>
                ...
                <div class='opc'>
                    ...
                    <input type='number' class='campos' id='id' required="required">
                    <span class='texto'>Nome:</span>
                    <input type='text' class='campos' id='nome' required="required">
                    <span class='texto'>Login:</span>
                    <input type='text' class='campos' id='login' required="required">
                    <span class='texto'>Senha:</span>
                    <input type='text' class='campos' id='senha' required="required">                    
                    <div class='botao'>
        ...
        <script>
                function salvar() {
                    ...
                    window.open('cadastrausuario_query.php?id='+$id+'&nome='+$nome+'&login='+$login+'&senha='+$senha, 'popup', 'width=400,height=300,scrolling=auto,top=0,left=0');
                }
        </script>
    </body>
</html>
