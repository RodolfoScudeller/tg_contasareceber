<?php
    ...
    $acao = "Visualizou Arquivos Retorno";
...
<head>
    ...
    <link rel="stylesheet" href='css/estilo_ret.css'>
    ...
    <body>
        ...
        <h1>Retornos</h1>
        <div class='addret'>
        <form enctype="multipart/form-data" action="ler_retorno.php" method="POST">
            <input type="file" name="file">
            <input class='carregar' type="submit" value="Carregar">
        </form>               
        </div>
